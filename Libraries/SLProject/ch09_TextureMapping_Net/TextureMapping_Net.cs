...
{  
   ...
   protected override void OnLoad(EventArgs e)
   {
      ...
      _shaderVertID = glUtils.BuildShader("../_globals/oglsl/ADSTex.vert", ShaderType.VertexShader);
      _shaderFragID = glUtils.BuildShader("../_globals/oglsl/ADSTex.frag", ShaderType.FragmentShader);
