...
{  
   ...
   _shaderVertID = glUtils::buildShader("../_globals/oglsl/ADSTex_Loesung.vert", GL_VERTEX_SHADER);
   _shaderFragID = glUtils::buildShader("../_globals/oglsl/ADSTex_Loesung.frag", GL_FRAGMENT_SHADER);
