...
SLstring SLGLShaderProg::defaultPath = "../_globals/oglsl/";
//-----------------------------------------------------------------------------
...
SLint SLGLShaderProg::uniform3f(const SLchar* name, SLfloat v0, SLfloat v1, SLfloat v2)
{  SLint loc = getUniformLocation(name);
...
SLint SLGLShaderProg::uniform4f(const SLchar* name, SLfloat v0, SLfloat v1, 
                               SLfloat v2, SLfloat v3)
{  SLint loc = getUniformLocation(name);
...
SLint SLGLShaderProg::uniform1fv(const SLchar* name, SLsizei count, const SLfloat* value)
{  SLint loc = getUniformLocation(name);
...
SLint SLGLShaderProg::uniform2fv(const SLchar* name, SLsizei count, const SLfloat* value)
{  SLint loc = getUniformLocation(name);
...
SLint SLGLShaderProg::uniform3fv(const SLchar* name, SLsizei count, const SLfloat* value)
{  SLint loc = getUniformLocation(name);
   if (loc==-1) return false;
...
SLint SLGLShaderProg::uniform4fv(const SLchar* name, SLsizei count, const SLfloat* value)
{  SLint loc = getUniformLocation(name);
...
SLint SLGLShaderProg::uniform1iv(const SLchar* name, SLsizei count, const SLint* value)
{  SLint loc = getUniformLocation(name);
...
SLint SLGLShaderProg::uniform2iv(const SLchar* name, SLsizei count, const SLint* value)
{  SLint loc = getUniformLocation(name);
...
SLint SLGLShaderProg::uniform3iv(const SLchar* name, SLsizei count, const SLint* value)
{  SLint loc = getUniformLocation(name);
...
SLint SLGLShaderProg::uniform4iv(const SLchar* name, SLsizei count, const SLint* value)
{  SLint loc = getUniformLocation(name);
