...
//-----------------------------------------------------------------------------
/*!
Bézier curve class that implements classic Bezier curve interpolation. The
math is originally based on the implementation from the book:
