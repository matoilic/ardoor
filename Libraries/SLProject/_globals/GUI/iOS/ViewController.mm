...
- (void)viewDidLoad
{
   ...
   // Initialize the SceneLibrary
   slInit(self.view.bounds.size.width, 
          self.view.bounds.size.height,
          140,
          cmdSceneRevolver, 
          pathUTF8, pathUTF8, pathUTF8, 
          (void*)&onPaintRTGL);
}
//-----------------------------------------------------------------------------
- (void)viewDidUnload
...
- (void)update
{  
   slResize(self.view.bounds.size.width, self.view.bounds.size.height);
}
//-----------------------------------------------------------------------------
...
{       
   ...
   if (m_touchDowns > 0) 
   {  if (m_touchDowns == 1) 
         slMouseUp(ButtonLeft, pos1.x, pos1.y, KeyNone);
      if (m_touchDowns == 2) 
         slTouch2Up(0, 0, 0, 0);      
   ...
   {  if (touchDownNowSec - m_lastTouchDownSec < 0.3f)
         slDoubleClick(ButtonLeft, pos1.x, pos1.y, KeyNone);
      else
         slMouseDown(ButtonLeft, pos1.x, pos1.y, KeyNone);
   } else 
   if (m_touchDowns == 2)
   {  if ([touches count] == 2)
      {  UITouch* touch2 = [myTouches objectAtIndex:1];
         CGPoint pos2 = [touch2 locationInView:touch2.view];
         slTouch2Down(pos1.x, pos1.y, pos2.x, pos2.y);
      } else
      if ([touches count] == 1) // delayed 2nd finger touch
      {  slTouch2Down(0, 0, 0, 0);
      }
   }
...
{       
   ...
   if (m_touchDowns == 1 && [touches count] == 1)
   {  slMouseMove(pos1.x, pos1.y);
   } else 
   if (m_touchDowns == 2 && [touches count] == 2)
   {  UITouch* touch2 = [myTouches objectAtIndex:1];
      CGPoint pos2 = [touch2 locationInView:touch2.view];
      slTouch2Move(pos1.x, pos1.y, pos2.x, pos2.y);
   }
...
{       
   ...
   {  UITouch* touch2 = [myTouches objectAtIndex:1];
      CGPoint pos2 = [touch2 locationInView:touch2.view];
      slTouch2Up(pos1.x, pos1.y, pos2.x, pos2.y);
   }
