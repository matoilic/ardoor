...
The SLShape class is derived from the SLEventhandler class and therefore all
shapes can act as a eventhandler. For the moment only the camera class handles
...
events that it gets from the qtSceneView class.
